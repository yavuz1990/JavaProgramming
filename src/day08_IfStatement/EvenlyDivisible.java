...
public class EvenlyDivisible {
    ...
    public static void main(String[] args) {
        ...
        boolean divisibleBy3 = number % 3 == 0;// if the remainder of a number divided by 3 is zero, then it's evenly divisible by 3
        boolean divisibleBy4 = number % 5 == 0;// if the remainder of a number divided by 5 is zero, then it's evenly divisible by 5

        System.out.println(number + " is divisible by 2: " + divisibleBy2);
        System.out.println(number + " is divisible by 3: " + divisibleBy3);
        System.out.println(number + " is divisible by 5: " + divisibleBy4);
