...
public class ScannerPractice {
    ...
    public static void main(String[] args) {
        /* // if you did not have this variable scanner(scan), that means scanner object is not reusable
        new Scanner(System.in).nextInt(); //  can one time used

        new Scanner(System.in).nextInt(); // can one time used
         */

        // can more time usable
