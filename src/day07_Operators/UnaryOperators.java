...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c++);//post increment:first passes the current value, then increases the value by 1 right away
        ...
        System.out.println(y--);//post increment:first passes the current value, then increases the value by 1 right away
